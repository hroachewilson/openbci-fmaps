...
# Author: Pouya Bashivan, https://github.com/pbashivan
...
def gen_images(locs, features, n_gridpoints, normalize=True,
    ...
    :param features: Feature matrix as [n_samples, n_features]
                                ...
                                (alpha1, alpha2, ... alpha16, beta1, beta2,... beta16)
    ...
    return np.swapaxes(np.asarray(temp_interp), 0, 1)[0]     # swap axes to have [samples, colors, W, H]
